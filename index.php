...
<!-- DISPLAY OK -->
    ...
    <!-- c < / -->
            <div class="row justify-content-md-center">
                ...
                style="margin:5px; width:110px" name="apagatudo" onclick="apagaTudo()" accessKey="c">C</button>
           
                <button type="button" class="btn btn-secondary btn-lg"
                style="margin:5px; width:50px" onclick="apagaChar()" accessKey="v">
                <i class="fas fa-arrow-left"></i></button>
               
                <button type="button" class="btn btn-secondary btn-lg"
                style="margin:5px; width:50px" onclick="divide()" accessKey="/">/</button>
    ...
    <!-- 7 8 9 * -->
            <div class="row justify-content-md-center">
                ...
                <button type="button" class="btn btn-secondary btn-lg"
                style="margin:5px; width:50px" onclick="adiciona('7')" accessKey="7">7</button>
   
                <button type="button" class="btn btn-secondary btn-lg"
                style="margin:5px; width:50px" onclick="adiciona('8')" accessKey="8">8</button>
   
                <button type="button" class="btn btn-secondary btn-lg"
                style="margin:5px; width:50px" onclick="adiciona('9')" accessKey="9">9</button>
 
                <button type="button" class="btn btn-secondary btn-lg"
                style="margin:5px; width:50px" onclick="multiplica()" accessKey="*">*</button>
    ...
    <!--  4 5 6 - -->
            <div class="row justify-content-md-center">
                ...
                <button type="button" class="btn btn-secondary btn-lg"
                style="margin:5px; width:50px" onclick="adiciona('4')" accessKey="4">4</button>
       
                <button type="button" class="btn btn-secondary btn-lg"
                style="margin:5px; width:50px" onclick="adiciona('5')" accessKey="5">5</button>
       
                <button type="button" class="btn btn-secondary btn-lg"
                style="margin:5px; width:50px" onclick="adiciona('6')" accessKey="6">6</button>
 
                <button type="button" class="btn btn-secondary btn-lg"
                style="margin:5px; width:50px" onclick="subtrai()" accessKey="-">-</button>
    ...
    <!--  1 2 3 + -->
            <div class="row justify-content-md-center">
                ...
                <button type="button" class="btn btn-secondary btn-lg"
                style="margin:5px; width:50px" onclick="adiciona('1')" accessKey="1">1</button>
           
                <button type="button" class="btn btn-secondary btn-lg"
                style="margin:5px; width:50px" onclick="adiciona('2')" accessKey="2">2</button>
           
                <button type="button" class="btn btn-secondary btn-lg"
                style="margin:5px; width:50px" onclick="adiciona('3')" accessKey="3">3</button>
           
                <button type="button" class="btn btn-secondary btn-lg"
                style="margin:5px; width:50px" onclick="soma()" accessKey="+">+</button>
    ...
    <!--  0 , = -->
            <div class="row justify-content-md-center">
                ...
                <button type="button" class="btn btn-secondary btn-lg"
                style="margin:5px; width:110px" onclick="adiciona('0')" accessKey="0">0</button>
           
                <button type="button" class="btn btn-secondary btn-lg"
                style="margin:5px; width:50px" onclick="adiciona('.')" accessKey=",">,</button>
           
                <button type="button" name="result" class="btn btn-secondary btn-lg"
                style="margin:5px; width:50px" onclick="resultado()" accessKey="=">=</button>
            </div>
        </form>
    </div>
</div>
